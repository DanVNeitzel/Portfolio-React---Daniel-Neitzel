...
`,b3=U.div`
  ...
  background: ${t=>t.theme.colors.gradientText};
  z-index: 1001;
`;function x3(){const[t,{toggle:i,setFalse:o}]=PC(!1),[r,u]=C.useState("home"),[f,d]=C.useState(!1),[p,h]=C.useState(!1),m=Fv();KC();const y=document.documentElement.scrollHeight-window.innerHeight,x=y>0?m/y*100:0,S=D=>{u(D),o();const z=document.getElementById(D);z?z.scrollIntoView({behavior:"smooth"}):window.scrollTo({top:0,behavior:"smooth"})},T=C.useCallback(()=>{h(!0),o()},[o]),j=C.useCallback(()=>{h(!1)},[]);return C.useEffect(()=>{const D=()=>T();return window.addEventListener("openCVModal",D),()=>window.removeEventListener("openCVModal",D)},[T]),C.useEffect(()=>{const z=["home","skills","projects","blog"].map(R=>document.getElementById(R)),k=new IntersectionObserver(R=>{R.forEach(L=>{L.isIntersecting&&L.intersectionRatio>.5&&u(L.target.id)})},{threshold:[.1,.5,.9],rootMargin:"-100px 0px -100px 0px"});return z.forEach(R=>{R&&k.observe(R)}),()=>{z.forEach(R=>{R&&k.unobserve(R)})}},[]),C.useEffect(()=>{const D=setTimeout(()=>{d(!0)},1e3);return()=>clearTimeout(D)},[]),C.useEffect(()=>{const D={home:"Daniel Neitzel - Desenvolvedor Front-End",skills:"Especialidades - Daniel Neitzel",projects:"Projetos - Daniel Neitzel",blog:"Blog - Daniel Neitzel"};document.title=D[r]||D.home},[r]),C.useEffect(()=>{const D=z=>{z.key==="Escape"&&t&&o()};return document.addEventListener("keydown",D),()=>document.removeEventListener("keydown",D)},[t,o]),C.useEffect(()=>(t||p?document.body.classList.add("no-scroll"):document.body.classList.remove("no-scroll"),()=>{document.body.classList.remove("no-scroll")}),[t,p]),f?v.jsxs(Oy,{theme:_i,children:[v.jsx(Vy,{}),v.jsx(jA,{children:v.jsxs(g3,{children:[v.jsx(v3,{}),v.jsx(b3,{progress:x}),v.jsx(L2,{onMenuToggle:i,isMenuOpen:t}),v.jsx(q2,{isOpen:t,onClose:o,activeSection:r,onSectionChange:S,onCVModalOpen:T}),v.jsxs(iA,{children:[v.jsx(Vf,{path:"/",element:v.jsxs(y3,{children:[v.jsx("section",{id:"home",children:v.jsx(W2,{onSectionChange:S})}),"  ",v.jsx("section",{id:"skills",children:v.jsx(tD,{onSectionChange:S})}),v.jsx("section",{id:"projects",children:v.jsx(jD,{})}),v.jsx("section",{id:"blog",children:v.jsx(BD,{})})]})}),v.jsx(Vf,{path:"/blog/:slug",element:v.jsx(e3,{})})]}),v.jsx(l3,{}),v.jsx(Nl,{children:p&&v.jsx(u3,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:j,children:v.jsxs(c3,{onClick:D=>D.stopPropagation(),initial:{scale:.8,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.8,opacity:0},transition:{type:"spring",damping:25,stiffness:300},children:[v.jsxs(f3,{children:[v.jsxs(d3,{children:["Currículo - Daniel Neitzel Vieira",v.jsx(h3,{onClick:j,children:"✕"})]}),v.jsx(p3,{onClick:()=>window.open("https://danielneitzel.dev/CV%20-%20Daniel%20Neitzel%20Vieira.pdf","_blank"),children:"Abrir em uma nova aba"})]}),v.jsx(m3,{children:v.jsx("iframe",{src:"https://danielneitzel.dev/CV%20-%20Daniel%20Neitzel%20Vieira.pdf",title:"Currículo Daniel Neitzel Vieira"})})]})})})]})})]}):v.jsxs(Oy,{theme:_i,children:[v.jsx(Vy,{}),v.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100vh",background:_i.colors.background,color:_i.colors.text},children:v.jsxs("div",{style:{textAlign:"center"},children:[v.jsx("div",{style:{fontSize:"2rem",marginBottom:"1rem",background:_i.colors.gradientText,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text"},children:"Carregando..."}),v.jsx("div",{style:{width:"50px",height:"3px",background:_i.colors.gradientText,margin:"0 auto",animation:"pulse 1.5s infinite"}})]})})]})}const $x=()=>{localStorage.removeItem("projects-animated"),localStorage.removeItem("skills-animated"),localStorage.removeItem("about-animated")};typeof window<"u"&&(window.resetAllAnimations=$x);typeof window<"u"&&(window.resetAnimations=$x);hT.createRoot(document.getElementById("root")).render(v.jsx(C.StrictMode,{children:v.jsx(x3,{})}));
